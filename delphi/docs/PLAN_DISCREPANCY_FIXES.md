...
silhouette → k) does NOT depend on any repness fixes (D4-D11). Those all happen
*after* clustering. The only fixes that affect clustering inputs are D2/D2b/D2c
(in-conv, sort order, vote counts) and D15 (moderation handling).
...
| D11 | Consensus selection | PR 9 | — | **DONE** ✓ |
| D12 | Comment priorities | PR 11 | — | **DONE** ✓ |
